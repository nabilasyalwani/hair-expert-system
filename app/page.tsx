    ...
    <div className="font-sans">
      <div
        className="flex min-h-screen items-center justify-start 
                    bg-[url('/img/HairExpertBackground.jpg')] bg-no-repeat 
                    ...
                    sm:bg-bottom
                    md:bg-cover
                    xl:bg-[position:100%_center]"
      >
        <nav className="flex flex-row justify-start absolute top-0 left-0 w-full h-20 px-8 sm:px-8 md:px-16">
          <img src="/img/logo.png" alt="Logo" className="h-7 mt-7" />
          <h2 className="ml-4 mt-7.5 text-lg font-semibold text-[#5b2882]">
            HairExpert
          </h2>
        </nav>

        <main className="flex w-full flex-col py-32 px-4 sm:px-8 md:px-16 lg:px-28 rounded-lg max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-3xl">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <a 
              ...
              className="cursor-pointer flex items-center justify-center 
                         border border-[#bd5ee6] bg-white max-w-fit shadow-xl shadow-purple-500/40 
                         rounded-4xl mt-8 px-12 py-2 text-[#413D6C] 
      ...
      <footer className="w-full bg-[#E0AEF5] relative">
        ...
        />
        <div className="absolute bottom-0 left-0 w-full px-4 sm:px-8 lg:px-28 py-4 flex justify-between items-center text-[#5b2882]">
