...
export default function Result() {
  ...
  return (
    <div className="font-sans bg-[#fcf9ff] min-h-screen flex flex-col ">
      ...
      />
      <nav className="flex flex-row justify-start absolute top-0 left-0 w-full h-20 z-20 px-8 sm:px-8 md:px-16">
      ...
      <div className="relative w-full top-15">
        <button
          onClick={() => router.push("/")}
          className="cursor-pointer absolute px-4 sm:px-8 lg:left-28 top-12 z-30 text-md font-semibold text-[#5b2882] 
        ...
        <div
          className="absolute left-1/2 lg:-translate-x-1/2 top-0 
